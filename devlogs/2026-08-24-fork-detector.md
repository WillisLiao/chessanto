...
The optional fork field is carried through `KeyMoment`, `ReportBuilder`, and `FactAuditor` without changing key-moment priorities or classification thresholds.
